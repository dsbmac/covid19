...
import vid1 from "../../data/DASH_1080.mp4"
...
export class MediaGallery extends React.Component {
  constructor() {
    ...
    this.images = [
      {
        original: require("../../static/originalFlatten.png"),
        embedUrl:
          "https://preview.redd.it/mo6ds5wswoo41.gif?format=mp4&s=751badacd73b272534208ee854b5a1ab61d10fcb",
        thumbnail:
          "https://b.thumbs.redditmedia.com/wy9r855KDgr0mb0QCFwwv_gAsOBzyEBpi1NMfJawTzI.jpg",
        renderItem: this._renderVideo.bind(this),
      },
      {
        original: require("../../static/640x480.png"),
        embedUrl: "https://v.redd.it/spi3k7fqbho41/DASH_1080?source=fallback",
        thumbnail:
          "https://b.thumbs.redditmedia.com/ALH1AVT2nlc6re-3jNpMSeSRx5oXtf02LznmlfSfc7Q.jpg",
        renderItem: this._renderVideo.bind(this),
      },
    ]
    // this.images = [
